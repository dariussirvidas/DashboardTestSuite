...
public class AddDomainTests {
    ...
    private final String latencyThreshold;
    ...
    public AddDomainTests(Object serviceName, Object url, Object serviceType, Object method, Object auth, Object user,
                         Object password, Object parameters, Object email, Object interval, Object latencyThreshold,
        ...
        this.latencyThreshold = (String) latencyThreshold;
    ...
    public static Collection<Object[]> data() throws Exception {
        ...
        for (Object o : dataArray) {
            ...
            Object[] parameter = {data.get("serviceName"), data.get("url"), data.get("serviceType"),
                    ...
                    data.get("parameters"), data.get("email"), data.get("interval"), data.get("latencyThreshold"),
